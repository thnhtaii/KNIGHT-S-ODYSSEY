...
class AIStatsLevel5Screen:
    ...
    def draw(self):
        ...
        # Title
        title = self.font_title.render("AI PERFORMANCE STATS - LEVEL 5", True, (255, 60, 60))
        ...
        for r_idx, row in enumerate(rows):
            ...
            for c_idx, text in enumerate(row):
                ...
                elif c_idx == 1: color = (100, 255, 100) # Iters
                elif c_idx == 2: color = (255, 200, 100) # Time
